...
const renderPostData = (posts) => posts.map((feed, index) => {
  const bodyEl = document.querySelector('.body');
  ...
  boxEl.append(renderModalWindow(`postModal-${index}`, feed.title, feed.description, feed.link));
